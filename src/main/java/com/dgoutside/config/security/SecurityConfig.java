package com.dgoutside.config.security;

import com.dgoutside.config.MyProperties;
import com.dgoutside.config.security.filter.AdminAuthenticationProcessingFilter;
import com.dgoutside.config.security.filter.MyAuthenticationFilter;
import com.dgoutside.config.security.filter.MyLogoutSuccessHandler;
import com.dgoutside.config.security.login.AdminAuthenticationEntryPoint;
import com.dgoutside.config.security.url.UrlAccessDecisionManager;
import com.dgoutside.config.security.url.UrlAccessDeniedHandler;
import com.dgoutside.config.security.url.UrlFilterInvocationSecurityMetadataSource;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
		...
		/*
		 * registry.and() .logout() .logoutUrl("/logout")
		 * .logoutSuccessHandler(myLogoutSuccessHandler) .deleteCookies("JSESSIONID")
		 * .permitAll();
		 */
