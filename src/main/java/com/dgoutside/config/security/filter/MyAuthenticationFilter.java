package com.dgoutside.config.security.filter;
...
import com.dgoutside.config.security.service.impl.UserDetailsServiceImpl;
import com.dgoutside.utils.MultiReadHttpServletRequest;
import com.dgoutside.utils.MultiReadHttpServletResponse;
...
//            }
            ...
            if (StringUtils.isNotBlank(jwtToken) && !"undefined".equals(jwtToken)) {
                ...
                System.out.println("获取当前过期时间: " + claims.getExpiration());
                // TODO 如需使用jwt特性在此做处理~
                // JWT相关end ===========================================
